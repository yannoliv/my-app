...
<FeatureDefault>
  ...
  <FeatureItem>
    ...
    <svelte:fragment slot="paragraph"
      ...
      workflows and custom permissions made for you.</svelte:fragment
    >
  </FeatureItem>
  <FeatureItem>
    <svelte:fragment slot="icon"
    ...
    <svelte:fragment slot="paragraph"
      ...
      hundreds of new templates to help you get started.</svelte:fragment
    >
  </FeatureItem>
  <FeatureItem>
    <svelte:fragment slot="icon"
  ...
  <FeatureItem>
    ...
    <svelte:fragment slot="paragraph"
      ...
      with real cross-company collaboration.</svelte:fragment
    >
  </FeatureItem>
  <FeatureItem>
    <svelte:fragment slot="icon"
