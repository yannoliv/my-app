  ...
  <FeatureDefault>
    <FeatureItem>
      <svelte:fragment slot="icon"
        ><PresentationChartLine class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
      /></svelte:fragment>
      ...
      <svelte:fragment slot="paragraph"
        ...
        marketing goals every month with our marketing plan.</svelte:fragment
      >
    </FeatureItem>
    <FeatureItem>
      <svelte:fragment slot="icon"
        ><AcademicCap class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
      /></svelte:fragment>
    ...
    <FeatureItem>
      <svelte:fragment slot="icon"
        ><Briefcase class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
      /></svelte:fragment>
    ...
    <FeatureItem>
      <svelte:fragment slot="icon"
        ><CurrencyDollar class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
      /></svelte:fragment>
    ...
    <FeatureItem>
      <svelte:fragment slot="icon"
        ><Bolt class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
      /></svelte:fragment>
    ...
    <FeatureItem>
      <svelte:fragment slot="icon"
        ><Cog class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
      /></svelte:fragment>
